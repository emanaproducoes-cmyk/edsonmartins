        ...
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            <p className="mt-5 text-pretty text-lg leading-relaxed text-muted-foreground">
              Os problemas reais de Rondônia são os mais básicos: Saúde Básica, Melhorias das Vias Rurais, Profissionalização para os Jovens - Vamos juntos nessa jornada.
            </p>
          </Reveal>
